...
function Datepicker() {
	this._defaults = {
		...
		yearRange: 'c-100:c+80', // Range of years to show in drop-down: 'any' for direct text entry
		...
		dateFormat: 'dd/MMM/yyyy', // Format for dates
...
var isdatecalopenforpick=0;





function applyAugCal(){

$('.hasDatepick').each(function(){	
	//alert(22);
	$(this).removeClass('hasDatepick');
});	
$('.augCalCssClass').each(function(){
...
$('.augCalImgCssClass').each(function(){

 this.onclick=function(){
 //alert(33);
 $(this).parent().find('.hasDatepick').each(function(){   
       this.focus();
              });
};
});
...
var augCal=new Array();

function setCaldata(nam,dtf){
